...
DROP POLICY IF EXISTS default_select_anon ON inventory_archive.position; -- IST Koodinaten
DROP POLICY IF EXISTS default_select_anon ON inventory_archive.plot_coordinates; -- SOLL Koordinaten
DROP POLICY IF EXISTS default_select_anon ON inventory_archive.plot_landmark; -- Freier Text
DROP POLICY IF EXISTS default_select_anon ON inventory_archive.subplots_relative_position; -- relative Plots