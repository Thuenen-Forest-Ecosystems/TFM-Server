...
BEGIN
    ...
    LOOP
        ...
        EXECUTE format('ALTER PUBLICATION %I ADD TABLE %I.%I', publication_name, schema_name, table_name_to_be_added);
    END LOOP;
END $$ LANGUAGE plpgsql;

SELECT add_all_tables_to_publication('powersync', 'ci2027');
