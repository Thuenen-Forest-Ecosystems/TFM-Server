...
ALTER TABLE lookup.lookup_interval ALTER COLUMN code TYPE text USING code::text;
INSERT INTO lookup.lookup_interval (code, name_de, name_en, sort)
VALUES
('bwi1987', 'BWI 1987', 'BWI 1987', 1),
...
VALUES
    (10, 'neue, erstmals eingemessene Grenze zu Nichtwald', 'New boundary to non-forest, measured for the first time', ARRAY['ci2027'], 10),
    (11, 'neue, erstmals eingemessene Grenze zu Nichtwald, welche auch für frühere Aufnahmen gilt', 'New boundary to non-forest, measured for the first time, which also applies to earlier surveys', ARRAY['ci2027'], 11),
    (12, 'aus früherer Aufnahme übernommene, immer noch gültige Grenze zu Nichtwald', 'Still valid boundary to non-forest, taken over from previous recording', ARRAY['ci2027'], 12),
    (20, 'neue, erstmals eingemessene Grenze zu Nichtholzboden', 'New boundary to unstocked forest land, measured for the first time', ARRAY['ci2027'], 20),
    (21, 'neue, erstmals eingemessene Grenze zu Nichtholzboden, welche auch für frühere Aufnahmen gilt', 'New boundary to unstocked forest land, measured for the first time, which also applies to earlier surveys', ARRAY['ci2027'], 21),
    (22, 'aus früherer Aufnahme übernommene, immer noch gültige Grenze zu Nichtholzboden', 'Still valid boundary to unstocked forest land, taken over from previous recording', ARRAY['ci2027'], 22),
    (30, 'neue, erstmals eingemessene Grenze zu nicht begehbaren Holzboden', 'New boundary to non-accessible forest floor measured for the first time', ARRAY['ci2027'], 30),
    (31, 'neue, erstmals eingemessene Grenze zu nicht begehbaren Holzboden, welche auch für frühere Aufnahmen gilt', 'New boundary to non-accessible forest, measured for the first time, which also applies to earlier surveys', ARRAY['ci2027'], 31),
    (32, 'aus früherer Aufnahme übernommene, immer noch gültige Grenze zu nicht begehbaren Holzboden', 'Still valid boundary to non-accessible forest, taken over from previous recording', ARRAY['ci2027'], 32),
    (42, 'aus früherer Aufnahme übernommene, immer noch gültige Bestandesgrenze', 'Still valid boundary between different stands, taken over from previous recording', ARRAY['ci2027'], 42),
    (99, 'Grenze einer früheren Aufnahme, die zum aktuellen Inventurzeitpunkt nicht mehr auffindbar bzw. nicht mehr gültig ist', 'Boundary of a previous inventory that can no longer be found or is no longer valid at the current survey', ARRAY['ci2027'], 99);
